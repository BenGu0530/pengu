...
inherited by importing grid6_sweep; the merge covers the extended columns too.
...
import grid6_sweep as g5                       # sets the grid5 protocol switches
...
def main():
    ...
    # calibrate at the hips-0 design neutral (identical to grid6_sweep.main)
