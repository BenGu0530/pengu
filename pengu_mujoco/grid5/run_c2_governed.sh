#!/usr/bin/env bash
# rml2 c2-slice runner with a LIVE shard governor (Ben, 2026-09-02).
#
#   nohup bash grid5/run_c2_governed.sh > results/gait_sweep/c2_slices_rml2.log 2>&1 &
#
