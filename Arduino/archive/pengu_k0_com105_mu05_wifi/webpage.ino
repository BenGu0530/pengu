...
<div class="ctrl">
  ...
  <div class="row">
    <button class="mini gait" id="g-n" onclick="pick('n')">n &middot; 1.95/20&deg;<br><small>rank 1</small></button>
    <button class="mini gait" id="g-m" onclick="pick('m')">m &middot; 1.92/10&deg;<br><small>rank 2</small></button>
    <button class="mini gait" id="g-j" onclick="pick('j')">j &middot; 1.63/10&deg;<br><small>fits motors</small></button>
  </div>
