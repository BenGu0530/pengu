...
<div class="ctrl">
  ...
  <div class="row">
    ...
    <button class="mini" onclick="send('i')">re-init motors</button>
  </div>

  <div class="lbl">gait &nbsp;<small>c1 &middot; kappa 0 &middot; COM 1.05 &middot; hip_phi 0 &middot; hip_off 20</small></div>
  <div class="row">
    <button class="mini gait" id="g-n" onclick="pick('n')">n &middot; 1.95<br><small>sim 0.350 m/s</small></button>
    <button class="mini gait" id="g-m" onclick="pick('m')">m &middot; 2.00<br><small>sim 0.314, robust</small></button>
    <button class="mini gait" id="g-j" onclick="pick('j')">j &middot; 1.69<br><small>sim 0.233</small></button>
  </div>
</div>
