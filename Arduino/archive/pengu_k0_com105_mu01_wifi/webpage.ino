...
<div class="ctrl">
  ...
  <div class="row">
    <button class="mini gait" id="g-n" onclick="pick('n')">n &middot; 1.80/50&deg;<br><small>rank 1</small></button>
    <button class="mini gait" id="g-m" onclick="pick('m')">m &middot; 1.65/30&deg;<br><small>less lean</small></button>
    <button class="mini gait" id="g-j" onclick="pick('j')">j &middot; 1.10/10&deg;<br><small>fits motors</small></button>
  </div>
