...
<div class="ctrl">
  ...
  <div class="row">
    <button class="mini gait" id="g-n" onclick="pick('n')">n &middot; 1.56/30&deg;<br><small>all fits</small></button>
    <button class="mini gait" id="g-m" onclick="pick('m')">m &middot; 1.42/40&deg;<br><small>more lean</small></button>
    <button class="mini gait" id="g-j" onclick="pick('j')">j &middot; 1.36/50&deg;<br><small>most lean</small></button>
  </div>
