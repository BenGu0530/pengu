// pengu_champ_k0_105.ino — GRID-4 c1 champion gait (COM-1.05 body, Gait 1: kappa=0,
// torso held WORLD-UPRIGHT by feedback), K=5-verified in sim at mu=0.1.
// !!! HARDWARE PREREQUISITE: counterweight relocated DOWN ~86 mm along the torso
// !!! mast (sim mc slide 1.31 -> 1.05). On the stock 1.31 build use pengu_champ_k0.
//
...
void setup() {
  ...
  DEBUG_SERIAL.println("pengu_champ_k0_105 (Gait 1, COM 1.05 build) ready. r=Ready w=Walk q=Idle s=SignCheck (serial or wifi)");
