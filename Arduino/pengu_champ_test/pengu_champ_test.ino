// pengu_champ_test.ino — SERIAL-ONLY test build. Same gait and same control law as
// pengu_champ, with two additions for the sim-vs-hardware comparison:
...
//
// (from) pengu_champ.ino — standalone sketch running the GRID-4 c6 champion gait// (COM-1.31 body, Gait 2: kappa=2 torso feedback), K=5-verified in sim at mu=0.1.
//
